...
|-------------------------------|---------------------------------------------|--------------------------------------------|--------------------------------------------|
|data_replication.managers           |create, update, delete [COMM-010][COMM-070][?COMM-030?] |нам необходим стриминг менеджеров? событий не много, можно писать все в один топик |формальная связь для стриминга менеджеров |
|data_replication.candidates           |create, update, delete? [COMM-090] | |формальная связь для стриминга кандидатов           |
|data_replication.lessons.created | create [COMM-020][COMM-080] |к созданному заданию нет требований по скорости доставки потребителям, по апдейтам есть и они будут доставляться синхронно, поэтому здесь только created |формальная связь для стриминга созданный заданий           |
|data_replication.candidate_assingment | |формальная связь для стриминга назначений задания на кандидата. использовал в имени топика кандидата и назначение, чтобы не спутать в последствии с назначением задачи на переделку менеджером
|| |
domain.task_management|[COMM-070][COMM-080] ||           | |
domain.hiring|taskSolved, taskFailed[COMM-030][COMM-040][COMM-050] | скорее это одно событие taskSolved, но со статусами success, failed|потому что это функциональная связь в контексте сервиса найма           | |
